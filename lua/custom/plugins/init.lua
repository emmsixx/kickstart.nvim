  ...
  },
  {
    ...
    config = function()
      require('presence').setup {
        ...
        neovim_image_text = 'One performative Neovim please 🤓', -- Text displayed when hovered over the Neovim image
        ...
        workspace_text = 'Coding rn...', -- Format string rendered when in a git repository (either string or function(project_name: string|nil, filename: string): string)
